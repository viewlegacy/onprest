...
| `make test-it-release-gate` | Full release gate. Runs unit, integration, stability, all-DB, MySQL special-credential, SQL Server TLS, and Docker operational checks, and asserts zero test/subtest skips and zero leftover Testcontainers resources. See [Release Gate](/operations/release-gate). |
