...
| `GATEWAY_IP_ALLOW_LIST` | empty | Comma-separated CIDRs or single IPs allowed to call gateway routes, including API-key-free `/healthz`; empty means no IP allow restriction |
