...
| Binary | Role |
|---|---|
| `onprest-gateway` | Authenticates callers and exposes REST, MCP, and OpenAPI endpoints |
| `onprest-agent` | Owns database access and executes the capabilities you define |
...
- [How Releases Are Checked](/operations/release-gate): See what is checked before publication.
